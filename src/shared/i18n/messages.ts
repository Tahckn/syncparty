...
export const en = {
  ...
  "host.lobby.filesMismatch": "Check the files before starting the countdown.",
  ...
  "host.lobby.start": "Start in 3 seconds",
  "host.lobby.countdown": "Starting in {count}…",
  "host.lobby.opened": "Syncplay opened",
  "host.lobby.hint":
    "The countdown opens Syncplay for the host. Syncplay keeps playback in step for everyone.",
...
export const tr: Messages = {
  ...
  "host.lobby.filesMismatch": "Sayacı başlatmadan önce dosyaları kontrol et.",
  ...
  "host.lobby.start": "3 saniye içinde başlat",
  "host.lobby.countdown": "{count} saniye sonra başlıyor…",
  "host.lobby.opened": "Syncplay açıldı",
  "host.lobby.hint":
    "Sayaç host için Syncplay'i açar. Oynatmayı herkes için Syncplay senkron tutar.",
